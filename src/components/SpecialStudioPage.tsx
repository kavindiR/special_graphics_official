...
const clientLogos = [
    { name: "Van Balen", image: "" },
    { name: "Image Wash", image: "" },
...
const works = [
    { id: 1, title: 'Pink Brand', color: 'bg-pink-600', image: '' },
    { id: 2, title: 'Orange Box', color: 'bg-orange-500', image: '' },
    { id: 3, title: 'Beige Tag', color: 'bg-[#D2B48C]', image: '' },
    { id: 4, title: 'Green Pattern', color: 'bg-emerald-800', image: '' },
    { id: 5, title: 'Red Festive', color: 'bg-red-600', image: '' },
    { id: 6, title: 'Dark Neon', color: 'bg-slate-900', image: '' },
    { id: 7, title: 'Blue Abstract', color: 'bg-blue-900', image: '' },
    { id: 8, title: 'Night Lights', color: 'bg-black', image: '' },
];
...
export default function SpecialStudioPage() {
  ...
  // 2. AUTO SLIDE EFFECT (Fixed: Added this back so it moves automatically)
  useEffect(() => {
  ...
  // --- BUTTON STYLES (For the Hover Arrow Effect) ---
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="w-full md:w-1/2 aspect-square relative bg-white p-4 shadow-lg rotate-1 md:rotate-0">
                 <div className="w-full h-full relative overflow-hidden bg-gray-200">
                     ...
                     {/* Manual Arrows */}
                     <button onClick={prevSlide} className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/80 hover:bg-white rounded-full flex items-center justify-center shadow-md transition-all z-10">
                        <ChevronLeft className="w-6 h-6 text-black" />
                     </button>
                     <button onClick={nextSlide} className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/80 hover:bg-white rounded-full flex items-center justify-center shadow-md transition-all z-10">
                     ...
                     <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-2 z-10">
                        {heroSlides.map((_, idx) => (
                            <div key={idx} className={`w-2 h-2 rounded-full ${idx === currentSlide ? 'bg-black' : 'bg-gray-300'}`}></div>
                        ))}
                     </div>
                 </div>
            </div>
            ...
            <div className="w-full md:w-1/2 pl-0 md:pl-12 space-y-8">
                {/* Heading Corrected: No line, Black text */}
                <div className="font-heading text-lg font-bold text-black uppercase tracking-widest mb-[-10px]">
                    Special
                </div>
                <h1 className="font-heading text-6xl md:text-7xl font-extrabold text-black leading-[0.9]">
                    Studio
                </h1>
                <div className="space-y-4">
                    <p className="font-heading text-xl font-bold text-gray-900 leading-snug">
                        The brand agency from Special Graphics. <br/>
                        Design packages managed by expert creatives.
                    </p>
                ...
                <div className="flex flex-wrap items-center gap-6 pt-6">
                    {/* Updated Button: "Talk to us" with Arrow Effect */}
                    <button className={primaryButtonClass}>
                        <span className={buttonTextClass}>Talk to us</span>
                        <ArrowRight className={buttonArrowClass} />
                    </button>
                    <button className="text-xs font-bold underline underline-offset-4 hover:text-gray-600 transition-colors">
         ...
         <div className="flex flex-col md:flex-row gap-20">
             <div className="w-full md:w-1/3 pt-10">
                 ...
                 <p className="text-base text-gray-600 leading-relaxed mb-8">
                    They're not completely random, actually. Special Studio is tailored for...
                 </p>
                 <ul className="space-y-4 text-base text-gray-900 font-bold mb-8">
                     <li>• Visual identity from scratch</li>
                     <li>• Rebranding established businesses</li>
                 </ul>
                 <p className="text-base text-gray-600 leading-relaxed">
                    Our dedicated team offers a streamlined process that ensures you get the creative outcome you need and deserve.
                 </p>
             </div>
             <div className="w-full md:w-2/3 grid grid-cols-2 gap-4">
                 <div className="aspect-square bg-gray-50 flex items-center justify-center p-4">
                    <div className="text-gray-300 text-sm">[Logo Sketch]</div>
                 </div>
                 <div className="aspect-square bg-white border border-gray-100 flex items-center justify-center p-4">
                    <div className="text-gray-300 text-sm">[Digital Art]</div>
                 </div>
                 <div className="aspect-square bg-purple-50 flex items-center justify-center p-4">
                    <div className="text-purple-300 text-sm">[Color Palette]</div>
                 </div>
                 <div className="aspect-square bg-purple-100 flex items-center justify-center p-4">
                    <div className="text-purple-400 text-sm">[Merchandise]</div>
                 </div>
             </div>
         </div>
      </section>
      ...
      <section className="bg-white py-12 px-6 md:px-12">
          <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row shadow-2xl rounded-sm overflow-hidden min-h-[500px]">
              ...
              <div className="w-full md:w-1/2 bg-white p-16 flex flex-col justify-center">
                  <h2 className="font-heading text-4xl font-extrabold text-gray-900 mb-6 leading-tight">
                      The full-service <br/> brand pack
                  </h2>
                  <p className="text-xs font-bold text-gray-400 mb-10 uppercase tracking-widest">
                  ...
                  <button className="bg-[#1A1A1A] text-white px-10 py-4 text-xs font-bold uppercase tracking-widest rounded-sm w-max hover:bg-black transition-colors">
                      Get Started
                  </button>
              </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-20 items-center">
              <div className="w-full md:w-1/2">
                  ...
                  <p className="text-lg text-gray-600 mb-10 max-w-lg leading-relaxed">
                      Looking for more? Or maybe less? We can tailor a package to suit your specific needs. Tell us what you need and we'll send a custom estimate.
                  </p>
                  <button className="bg-[#1A1A1A] text-white px-10 py-4 text-xs font-bold uppercase tracking-widest rounded-sm hover:bg-black">
                      Contact Us
                  </button>
              </div>
              ...
              <div className="w-full md:w-1/2 h-[350px] bg-[#A4C936] relative flex items-center justify-center overflow-hidden rounded-sm shadow-inner">
                  <div className="w-40 h-64 bg-black rotate-12 absolute left-1/4 shadow-2xl flex items-center justify-center border border-gray-800">
                      <span className="text-white/80 text-xs font-mono tracking-widest -rotate-90">BRAND</span>
                  </div>
                  <div className="w-40 h-64 bg-black -rotate-6 absolute right-1/4 shadow-2xl flex items-center justify-center border border-gray-800">
                      <span className="text-white/80 text-xs font-mono tracking-widest -rotate-90">IDENTITY</span>
                  </div>
              </div>
          </div>
      </section>
      ...
      <section className="py-20 px-6 md:px-12 max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-24 items-start">
              {clientLogos.map((client, index) => (
                  <div 
                    key={index} 
                    className={`flex items-center justify-center ${index % 2 === 0 ? 'mt-0' : 'mt-12'}`}
                  >
                      <div className="h-16 w-32 bg-gray-100 border border-gray-200 flex items-center justify-center text-xs text-gray-400 font-bold">
                          {client.name}
                      </div>
                  </div>
              ))}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {works.map((work) => (
                  <div key={work.id} className={`aspect-square ${work.color} relative group overflow-hidden cursor-pointer shadow-sm hover:shadow-xl transition-shadow`}>
                      <div className="absolute inset-0 flex items-center justify-center text-white/40 text-sm font-bold p-4 text-center">
                          [{work.title}]
                      </div>
      ...
      <section className="py-32 px-6 md:px-12 max-w-4xl mx-auto">
          ...
          <div className="flex justify-end mb-8 relative">
              <input 
                ...
                className="border-b border-gray-300 pb-2 pr-8 text-sm focus:outline-none focus:border-black w-64 transition-colors"
              />
          ...
          <div className="flex gap-12 border-b border-gray-200 mb-10">
              <button 
                  onClick={() => { setActiveFaqTab('studio'); setOpenFaqIndex(null); }}
                  className={`pb-4 text-sm font-bold transition-colors ${activeFaqTab === 'studio' ? 'text-black border-b-2 border-black' : 'text-gray-400 hover:text-gray-600'}`}
              >
                  Studio Related FAQs
              </button>
              <button 
                  onClick={() => { setActiveFaqTab('general'); setOpenFaqIndex(null); }}
                  className={`pb-4 text-sm font-bold transition-colors ${activeFaqTab === 'general' ? 'text-black border-b-2 border-black' : 'text-gray-400 hover:text-gray-600'}`}
              >
                  General
              </button>
          </div>
                  ...
                  filteredFaqs.map((item, index) => (
                      <div key={index} className="border-b border-gray-100 pb-6">
                          <button 
                              ...
                              className="flex justify-between items-center w-full text-left py-2 hover:opacity-70 transition-opacity"
                          >

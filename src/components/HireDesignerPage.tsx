...
import { Search, Filter, Star, Trophy, MessageCircle, CheckCircle2, ArrowRight } from 'lucide-react';
...
export default function HireDesignerPage() {
    ...
    const handleHireDesigner = (designerId: number) => {
        if (!isAuthenticated) {
            // Redirect to auth page
            window.location.href = '/auth';
            return;
        }
        // Navigate to designer profile or hiring page
        window.location.href = `/designer/${designerId}/hire`;
    };
            ...
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <div className="max-w-3xl">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4">Hire a Designer</h1>
                        <p className="text-xl text-gray-300 mb-8">
                            Browse our community of talented designers and hire directly for your project. 
                            Work one-on-one with experts who match your needs.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link href="/start-contest">
                                <Button className="bg-white text-black hover:bg-gray-100">
                                    Or Start a Contest Instead
                                    ...
                                    <div className="p-4 relative">
                                        ...
                                        <div className="mt-8">
                                            ...
                                            <div className="flex items-center gap-2 mb-3">
                                                <span className="text-xs text-gray-500">{designer.hourlyRate}/hr</span>
                                                {designer.isAvailable && (
                                                    <Badge variant="secondary" className="text-[10px] px-1.5 py-0 h-5 bg-green-50 text-green-700">
                                            ...
                                            <div className="flex gap-2">
                                                <Button 
                                                    ...
                                                    onClick={() => handleHireDesigner(designer.id)}
                                                >
                                                    Hire Now
                                                </Button>
                                                <Button 
